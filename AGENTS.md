...
│   ├── admin/                                # 38 endpoint, ADMIN only (`hasRole("ADMIN")`): 20 existing + 18 Phase 1 baru
...
│   │   ├── AdminEventController.java         # Phase 1: /api/admin/events/* (8: list/detail/create/update/status/delete/sales/export)
│   │   ├── AdminTicketController.java        # Phase 1: /api/admin/tickets/* (7: list/detail/generate/revoke/checkin/inventory/export)
│   │   └── AdminTransactionController.java   # Phase 1: /api/admin/transactions/* (4: list/detail/status/export)
